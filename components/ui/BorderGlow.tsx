...
const BorderGlow: React.FC<BorderGlowProps> = ({
  ...
  useEffect(() => {
    ...
    const loop = (currentTime: number) => {
      ...
      // Clockwise rotation (3 seconds per full rotation)
      // Starting from bottom-right (approx 135deg)
      const rotationSpeed = 3000; 
      const angle = 135 + (elapsed / rotationSpeed) * 360;
      setCursorAngle(angle % 360);

      // Varied intensity (Sine wave pulse)
      const pulseSpeed = 1500;
      const pulse = 0.4 + Math.sin(elapsed / pulseSpeed * Math.PI) * 0.4; 
  ...
  const colorSensitivity = animated ? 0 : (edgeSensitivity + 20);
      ...
      <div
        ...
        style={{
          ...
          maskImage: [
            ...
            'radial-gradient(ellipse at 50% 50%, black 60%, transparent 90%)',
          ...
          opacity: borderOpacity * fillOpacity * 0.5,
