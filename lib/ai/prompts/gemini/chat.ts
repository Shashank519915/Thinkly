...
export function getChatSystemInstruction(): string {
  return [
    "STRICT ARCHITECT REFINEMENT MODE: Gemini for Thinkly.",
    ...
    "- Every node MUST belong to a 'stage' (e.g. 'Ingestion', 'Processing').",
    "- Fault Tolerance: Action nodes involving APIs MUST have an 'errorNodes' path.",
    ...
    "- Trigger: User wants to add, remove, update, or disconnect nodes.",
